...
@onready var name_input = $CenterContainer/VBoxContainer/NameLineEdit
@onready var background_select = $CenterContainer/VBoxContainer/BackgroundOption
@onready var create_btn = $CenterContainer/VBoxContainer/CreateButton
...
func _ready():
	...
	create_btn.pressed.connect(_on_create_button_pressed)
...
func _on_create_button_pressed() -> void:
	...
	create_btn.disabled = true #replace with function body.
